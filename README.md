<a name="readme-top"></a>
<div align="center">
  <h3><b>The BookStore Project</b></h3>
</div>
...
**[bookstore]** is a project that allows one to store and manage list of game scores.
...
```sh
  git clone git@github.com:chudisoft/bookstore.git
  cd bookstore
  code .
```
-
